(function ($,ReactionTimeGame,EventDispatcher) {

  ReactionTimeGame.Shape = function ( paramsObj) {
    ...
    this.timer = new ReactionTimeGame.Timer();
...
ReactionTimeGame.Shape.prototype.draw = function($canvas,$container){
    ...
    const top = (Math.random()*(that.canvasSize/4));
    const left = Math.random()*(window.innerWidth/2);
...
})(H5P.jQuery,H5P.ReactionTimeGame,H5P.EventDispatcher);
